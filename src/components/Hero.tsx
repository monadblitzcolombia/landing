      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full pt-24 pb-16">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-[0.6] text-center lg:text-left">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[1.1] mb-6 font-heading">
              MONAD TOUR
              <br />
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a
                href="#ciudades"
                className="bg-monad-primary text-white font-bold px-8 py-3 rounded-md hover:brightness-110 transition-all text-center font-mono uppercase tracking-wide btn-glow"
              >
                Regístrate
              </a>
              <a
          ...
          {/* Right: Map */}
          <div className="flex-[0.4] w-full max-w-md lg:max-w-none">
            {/* Desktop: interactive Leaflet map */}
